...
class PlaceholderMakerTests(unittest.TestCase):
    ...
    def test_do_element(self):
        ...
        self.assertEqual(result, u"<p>This is a tag with \ue007 text.</p>")
        ...
        replacer.do_element(element)
        result = etree.tounicode(element)
        self.assertEqual(result, u"<p>This is a \ue009\ue008 with \ue00a text.</p>")
    ...
    def test_do_undo_element(self):
        ...
        self.assertEqual(
            element.text, u"This \ue005 a \ue006 with \ue008formatted" u"\ue007 text."
        )
  ...
  <section>
    <para>
      ...
      .\u201c<insert>New </insert>Text\u201d
        ...
        replacer.placeholder2tag[u"\ue006"].element.attrib[delete_attrib] = ""
        replacer.placeholder2tag[u"\ue007"].element.attrib[delete_attrib] = ""
  ...
  <section>
    ...
    def test_placeholder_overflow(self):
        ...
        try:
            ...
            #
            self.assertEqual(
                element.text, u"This \uf904 a \uf905 with \uf907some" u"\uf906 text."
            )
...
class XMLFormatTests(unittest.TestCase):
    ...
    def test_insert_attr(self):
        ...
        expected = (
            START + u' attr="val" diff:add-attr="attr">' u"We need more text" + END
        )
    ...
    def test_move_attr(self):
        ...
        expected = START + u' bottr="val" diff:rename-attr="attr:bottr"' u">Text" + END
    ...
    def test_move_node(self):
        ...
        expected = (
            START + u' id="1" diff:delete=""/><node id="2"/><node '
        ...
        expected = (
            START + u' id="2" diff:insert=""/><node id="1"/><node '
    ...
    def test_rename_node(self):
        ...
        expected = START + u'><newtag diff:rename="para">Content' "</newtag>Tail" + END
    ...
    def test_update_attr(self):
        ...
        expected = (
            START + u' attr="newval" diff:update-attr="attr:val"/>' u"</document>"
        )
    ...
    def test_update_text_in(self):
        ...
        expected = (
            START + u"><diff:delete>This is</diff:delete><diff:insert>"
    ...
    def test_update_text_after_1(self):
        ...
        expected = START + u"/><diff:insert>Text</diff:insert>" u"<node/></document>"
    ...
    def test_update_text_after_2(self):
        ...
        expected = (
            START + u"/><diff:delete>This is</diff:delete>"
...
class DiffFormatTests(unittest.TestCase):
    ...
    def test_update_text_in(self):
        ...
        action = actions.UpdateTextIn("/document/node", 'Also a bit of text, "rick"')
        expected = "[update-text, /document/node, " u'"Also a bit of text, \\"rick\\""]'
        self._format_test(action, expected)
    ...
    def test_update_text_after_2(self):
        action = actions.UpdateTextAfter("/document/node", "Also a bit of text, rick")
        expected = "[update-text-after, /document/node, " u'"Also a bit of text, rick"]'
        self._format_test(action, expected)
...
class XmlDiffFormatTests(unittest.TestCase):
    ...
    def test_update_text_in(self):
        ...
        action = actions.UpdateTextIn("/document/node", 'Also a bit of text, "rick"')
        expected = (
            "[update, /document/node/text()[1], " u'"Also a bit of text, \\"rick\\""]'
        )
        self._format_test(action, expected)
    ...
    def test_update_text_after_2(self):
        action = actions.UpdateTextAfter("/document/node", "Also a bit of text, rick")
        expected = "[update, /document/node/text()[2], " u'"Also a bit of text, rick"]'
        self._format_test(action, expected)
